...
static char *longlong_to_string(char *buf, unsigned long long n, int len, uint32_t flag)
{
	int pos = len;
	int negative = 0;
...
static char *longlong_to_hexstring(char *buf, unsigned long long u, int len, uint32_t flag)
{
	int pos = len;
